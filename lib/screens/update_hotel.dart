...
class UpdateHotelScreen extends StatefulWidget {
  ...
  @override
  _UpdateHotelScreenState createState() =>
      // ignore: no_logic_in_create_state
      _UpdateHotelScreenState(myhotel: hotel);
}

class _UpdateHotelScreenState extends State<UpdateHotelScreen> {
  _UpdateHotelScreenState({
  ...
  void initState() {
    ...
    stateController.text = myhotel.state;
    cityController.text = myhotel.city;
                  ...
                  createDealController
                    ...
                    if (value) {
                      b2bController
                          .fetchB2BDeals()
                          .then(
                            (value) => b2bController.fetchMyDeals(
